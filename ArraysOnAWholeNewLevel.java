...
public class ArraysOnAWholeNewLevel {
    public static void main(String []args){
        // Creates a new array that holds 10 items, from index 0 to 9
        int[] oneD = new int[10];
        // Creates a rectangular array with 10 rows and 5 colums
        ...
        for (int row = 0; row < twoD.length; row++){
            // twoD[0].length gets the length of the 0th col, which is the
